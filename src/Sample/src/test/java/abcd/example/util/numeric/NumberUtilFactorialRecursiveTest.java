...
public class NumberUtilFactorialRecursiveTest {
    public IntLongDataInfo dataInfo;

    public NumberUtilFactorialRecursiveTest(IntLongDataInfo dataInfo)
    {
    ...
    public void test()
    {
        Assert.assertEquals(dataInfo.expected, NumberUtil.factorialRecursive(dataInfo.input));
    }
