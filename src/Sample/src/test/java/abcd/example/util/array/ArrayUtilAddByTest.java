...
public class ArrayUtilAddByTest {
    ...
    static class DataInfo {
        ...
        public DataInfo(int[] input1, int input2, int[] expected)
        {
            ...
            ArrayUtil.addBy(resultedArray, input2);
        }
    }

    public ArrayUtilAddByTest(DataInfo dataInfo)
    {
    ...
    {
        return List.of(
                new DataInfo(new int[]{1, 2, 3, 4}, 1, new int[]{2, 3, 4, 5}),
                new DataInfo(new int[]{1, 2, 3}, -1, new int[]{0, 1, 2})
        );
    }
