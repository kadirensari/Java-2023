...
public class ArrayUtilMaxTest {
    ...
    public ArrayUtilMaxTest(ArrayIntDataInfo dataInfo)
    {
    ...
    {
        return List.of(
                new ArrayIntDataInfo(new int[]{-1, 0, 1, 2}, 2),
                new ArrayIntDataInfo(new int[]{-4, -3, -2, -1}, -1),
                new ArrayIntDataInfo(new int[]{1, 2, 3, 4}, 4),
    ...
    public void test()
    {
        Assert.assertEquals(dataInfo.expected, ArrayUtil.max(dataInfo.input));
    }
